      ...
      <div>
        <Box className="hero-banner">
          ...
          <Typography variant="body1">
            We’re looking for talented, driven individuals to help shape the
            future.
          </Typography>
        </Box>
        ...
        <Box className="job-listings">
            ...
            {jobListings.map((job, index) => (
              <Grid item xs={12} sm={6} md={4} key={index}>
                <div className="job-card">
                  ...
                  <Link href="/career/resumesubmisstion" className="apply-btn">
                    Apply Now
                  </Link>
                </div>
              </Grid>
          ...
          <Box className="resume-section">
            ...
            <Link href="/career/resumesubmisstion">
